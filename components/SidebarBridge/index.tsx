...
export const SidebarBridge: React.FC<SidebarProps> = ({ children }) => {
    ...
    <>
      <div className="flex flex-col lg:flex-row w-full h-auto min-h-full flex-1 font-space-grotesk">
                      ...
                      <ul role="list" className="flex flex-1 flex-col gap-y-7">
                        <li>
                          <ul role="list" className="-mx-2 space-y-1">
                            {renderNavigationItems(sidebarItems, pathname)}
                          </ul>
                        </li>
                      </ul>
                    </nav>
        ...
        <div className="hidden lg:flex flex-none w-72 main-content">
          <div className="flex grow flex-col gap-y-5 overflow-y-auto bg-main-light dark:bg-main-dark p-6">
            <nav className="flex flex-1 flex-col">
              <ul role="list" className="flex flex-1 flex-col gap-y-7">
                <li>
                  <ul role="list" className="-mx-2 space-y-1">
