...
#### Please upgrade your cosmovisor version to <a href="https://github.com/cosmos/cosmos-sdk/releases/tag/cosmovisor%2Fv1.5.0" target="_blank" rel="noopener noreferrer" style={{ color: '#24D494' }}>v1.5.0</a>
...
#### Please upgrade your cosmovisor version to <a href="https://github.com/cosmos/cosmos-sdk/releases/tag/cosmovisor%2Fv1.5.0" target="_blank" rel="noopener noreferrer" style={{ color: '#24D494', fontWeight: 'bold' }}>v1.5.0</a> before preparing for the upgrade.
