...
| **Cored version**      | v3.0.3                                                                                                       | v3.0.3                                                                                                                                                   | You can find the link to binary at [this page](/docs/become-validator/essentials/install-cored) | already installed via crust |
| **Upgrade name**       | Check the `Name` column [here](/docs/become-validator/upgrades/history#mainnet)                              | Check the `Name` column [here](/docs/become-validator/upgrades/history#testnet)                                                                          | genesis                                                  | genesis                     |
