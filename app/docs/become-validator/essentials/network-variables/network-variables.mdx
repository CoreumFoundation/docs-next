...
| **Cored version**      | v4.0.0                                                                                                      | v4.0.0                                                                                                                                                   | You can find the link to binary at [this page](./install-cored) | already installed via crust |
| **Upgrade name**       | Check the `Name` column [here](../upgrades/history)                                                 | Check the `Name` column [here](../upgrades/history)                                                                                             | genesis                                                  | genesis                     |
