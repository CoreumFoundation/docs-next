...
| **State sync servers(1)** | https://full-node-californium.mainnet-1.coreum.dev:26657                                                     | https://full-node-eris.testnet-1.coreum.dev:26657                                                  | not supported                                            | not supported               |
| **State sync servers(2)** | https://full-node-curium.mainnet-1.coreum.dev:26657                                                          | https://full-node-pluto.testnet-1.coreum.dev:26657                                                     | not supported                                            | not supported               |
