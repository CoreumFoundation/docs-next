...
| **Cored version**      | v3.0.3                                                                                                       | v3.0.3                                                                                                                                                   | You can find the link to binary at [this page](./install-cored) | already installed via crust |
| **Upgrade name**       | Check the `Name` column [here](../upgrades/history#mainnet)                                                  | Check the `Name` column [here](../upgrades/history#testnet)                                                                                              | genesis                                                  | genesis                     |
