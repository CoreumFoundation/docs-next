...
* Download `cored` and make it executable:
    * For Mainnet and Testnet:
      ...
      ```
      And check if it generates right link. It should lead to one of our [releases](https://github.com/CoreumFoundation/coreum/releases).
...
* Download `cored`:
  * For Mainnet and Testnet:
    ...
    echo https://github.com/CoreumFoundation/coreum/releases/download/$COREUM_VERSION/$COREUM_BINARY_NAME
    ```
    And check if it generates right link. It should lead to one of our <a href="https://github.com/CoreumFoundation/coreum/releases" target="_blank" rel="noopener noreferrer" style={{ color: '#24D494' }}>releases</a>.
.
    If it doesn't - double-check your network variables.
...
The The <a href="https://github.com/CoreumFoundation/coreum/blob/master/README.md#build-and-play" target="_blank" rel="noopener noreferrer" style={{ color: '#24D494' }}>Build and Play</a> doc describes the process of building and installation the `cored` binary from sources.
 doc describes the
