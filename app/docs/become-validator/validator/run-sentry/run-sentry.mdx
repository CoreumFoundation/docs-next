...
<a href="https://docs.tendermint.com/v0.34/tendermint-core/validators.html" target="_blank" rel="noopener noreferrer" className="text-[#24D494]">Here</a> you can find additional information about this node type.

* <a href="/docs/become-validator/essentials/system-requirements" target="_blank" rel="noopener noreferrer" className="text-[#24D494]">Check requirements</a>.

* <a href="/docs/become-validator/essentials/install-cored" target="_blank" rel="noopener noreferrer" className="text-[#24D494]">Install cored binary</a>.

* Verify that <a href="/docs/become-validator/essentials/network-variables" target="_blank" rel="noopener noreferrer" className="text-[#24D494]">network variables</a> are set up correctly.

* <a href="/docs/become-validator/essentials/node-prerequisites" target="_blank" rel="noopener noreferrer" className="text-[#24D494]">Set up node prerequisites</a>
...
* Capture the validator peer and ip that this node will connect to.
  ...
  **Attention!** *This command must be executed on the validator node.
  The "$COREUM_EXTERNAL_IP" is configured in the [doc](/docs/become-validator/essentials/connection-config)",
