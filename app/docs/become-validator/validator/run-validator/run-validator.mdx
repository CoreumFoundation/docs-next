...
* Fund the account.
  ...
  * For the Testnet and Devnet you can request test tokens at <a className="text-[#24D494] font-bold" href="https://discord.gg/VgkhYeWmTd" target="_blank">discord channel</a>
