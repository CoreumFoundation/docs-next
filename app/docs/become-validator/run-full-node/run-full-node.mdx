...
* Enable state-sync, so your validator can sync by snapshot. 
  ...
  instead of state-sync you should visit <a href="/docs/become-validator/upgrades/history" rel="noopener noreferrer" className="text-[#24D494] font-bold">this section</a>
