...
* Install <a href="https://www.rust-lang.org/tools-and-ecosystem/install" target="_blank" rel="noopener noreferrer" className="text-[#25D695] hover:opacity-80 text-base font-bold">rust and cargo</a>.
