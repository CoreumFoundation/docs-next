...
Use the [faucet](/docs/v4/tools/faucet) to fund your account
...
about [Coreum Fungible Token](/docs/v4/modules/coreum-fungible-token). Also, on the instantiation we declare the `owner` the address of
