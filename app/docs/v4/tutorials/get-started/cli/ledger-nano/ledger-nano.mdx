...
* The Cosmos(ATOM) application must be installed on your Ledger device, for more information click <a href="https://support.ledger.com/hc/en-us/articles/360013713840-Cosmos-ATOM-?support=true" target="_blank" rel="noopener noreferrer" className="text-[#25D695] hover:opacity-80 text-base font-bold">here</a>. (Make sure that Cosmos(ATOM) app version is v2.34.12 or above)

* `cored` ([Coreum CLI](/docs/v4/tutorials/get-started/install-cored)) installed on your local machine (install cored binary version v1.0.0 or above)
...
> - If you want to target other network than testnet, replace it with values at [network variables page](/docs/v4/tutorials/get-started/setup-cli)
...
* Fund your account address
  ...
  * Navigate [faucet page](/docs/v4/tools-and-ecosystem/faucet) designed specifically for this purpose.
...
* Connect to the [Coreum Chain](/docs/v4/tools-and-ecosystem/wallets) to add the Coreum account.
  >[!NOTE]
  > OPTIONAL
...
>
> listed on [Coreum Docs page](/docs/v4/tools-and-ecosystem/wallets).
...
* To fund the test account:
  ...
  * Open the [faucet](/docs/v4/tools-and-ecosystem/faucet) and paste the copied address into the designated address field.
...
Great! You have successfully set up Keplr with your Ledger Nano. For more comprehensive details, you can refer to the <a href="https://support.ledger.com/hc/en-us/articles/4411149814417?docs=true" target="_blank" rel="noopener noreferrer" className="text-[#25D695] hover:opacity-80 text-base font-bold">Ledger support page</a>.
