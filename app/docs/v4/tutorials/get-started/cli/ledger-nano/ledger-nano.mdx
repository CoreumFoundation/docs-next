...
* Fund your account address
  ...
  * Navigate [faucet page](/docs/v4/tools/faucet) designed specifically for this purpose.
...
* Connect to the [Coreum Chain](/docs/v4/tools/wallets) to add the Coreum account.
  >[!NOTE]
  > OPTIONAL
...
>
> listed on [Coreum Docs page](/docs/v4/tools/wallets).
...
* To fund the test account:
  ...
  * Open the [faucet](/docs/v4/tools/faucet) and paste the copied address into the designated address field.
