...
* You should have funded account. If you don't have it, do next:
  * Go to [faucet page](/docs/v4/tools/faucet) and click `Generate Funded Wallet`.
...
* Transfer funds. Let's go step by step, `--help` command will lead us through:
  ...
  * `bank` module is responsible for transferring funds:
    ...
    -   If the output code is 0, get the transaction hash, go to
        [Block Explorer](/docs/v4/tools/blockchain-explorers) and put it into the search line.
...
-   Let's delegate some tokens:
  ...
  * If the output code is 0, get the transaction hash, go to [Block Explorer](/docs/v4/tools/blockchain-explorers) and put it into the search line.
