...
3. Put the code from the [following section](#issuing-minting-and-sending-ft-token) into `index.js` file. Reffer to the comments for the explanation.
4. Generate mnemonic for the testnet network [here](/docs/v4/tools/faucet).
...
// Replace the issuerMnemonic with your own. You can generate it at https://docs.coreum.dev/docs/v4/v4/tools/faucet
...
// Replace the issuerMnemonic with your own. You can generate it at https://docs.coreum.dev/docs/v4/tools/faucet
// Caution: do not hardcode your production mnemonic here, otherwise your funds might be stolen.
const issuerMnemonic =
    "spend build hurdle notable lemon involve summer pudding sadness fit excite canyon flock relief unfold upgrade sure film alley chest census quiz ivory birth";
