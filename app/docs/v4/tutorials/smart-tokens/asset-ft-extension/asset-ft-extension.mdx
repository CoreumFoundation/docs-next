...
We can issue a new token like explain in [Create and Manage FT with CLI](/docs/v4/tutorials/smart-tokens/create-and-manage-ft) but pass additional params for the extension.
