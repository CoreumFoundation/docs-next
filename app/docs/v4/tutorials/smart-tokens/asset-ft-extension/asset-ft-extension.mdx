...
* Install <a className="text-[#24D494] font-bold text-base" href="https://www.rust-lang.org/tools-and-ecosystem/install" target="_blank">rust and cargo</a>.
...
We can issue a new token like explain in [Create and Manage FT with CLI](/docs/v4/tutorials/use-tokens/create-and-manage-ft-with-cli) but pass additional params for the extension.
...
* Check other [tutorials](/docs/v4/overview/tutorials) to find something you might be interested in additionally.
