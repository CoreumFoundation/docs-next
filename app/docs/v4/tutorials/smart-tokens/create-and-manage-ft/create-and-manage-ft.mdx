...
-   You should have two accounts on your local keychain. If you do not have them, you can go to the
    [faucet page](/docs/v4/tools/faucet) and generate funded accounts for the testnet.
...
```bash
  ...
  Copy this hash and go to the [Block explorer](/docs/v4/tools/blockchain-explorers) to see the transaction's status.
...
-   First, we need a third account to transfer tokens to, let's [generate](/docs/v4/tools/faucet) it and prepare:
    ```bash
