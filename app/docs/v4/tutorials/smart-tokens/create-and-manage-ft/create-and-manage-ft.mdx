...
This tutorial will guide you through the process of using the [assetft](/docs/v4/modules/coreum-fungible-token)
...
-   [Install cored binary](/docs/v4/tutorials/get-started/install-cored)

-   You should have two accounts on your local keychain. If you do not have them, you can go to the
    [faucet page](/docs/v4/tools-and-ecosystem/faucet) and generate funded accounts for the testnet.
...
```bash
  ...
  Copy this hash and go to the [Block explorer](/docs/v4/tools-and-ecosystem/blockchain-explorers) to see the transaction's status.
...
-   First, we need a third account to transfer tokens to, let's [generate](/docs/v4/tools-and-ecosystem/faucet) it and prepare:
    ```bash
...
You can read more about Fungible Tokens at [Smart Token Spec](/docs/v4/modules/coreum-fungible-token) pages
