...
The [Using CosmJS#](/docs/v4/tutorials/get-started/wasm/using-cosmjs-with-wasm-contracts) explains how to generate the TypeScript code from the protos, here for the simplicity
...
* Read Coreum [modules](/docs/v4/modules) specification, to be familiar with the custom Coreum functionality you can
  use for your
  application.
