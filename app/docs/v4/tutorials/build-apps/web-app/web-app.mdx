...
* Install <a href="https://yarnpkg.com/" target="_blank" rel="noopener noreferrer" className="text-[#25D695] hover:opacity-80 text-base font-bold">yarn</a> package manager.
...
* <a href="https://nextjs.org/" target="_blank" rel="noopener noreferrer" className="text-[#25D695] hover:opacity-80 text-base font-bold">Next.js</a> - react based framework for the web-applications.
* <a href="https://react.dev/" target="_blank" rel="noopener noreferrer" className="text-[#25D695] hover:opacity-80 text-base font-bold">React</a> - a web framework for the component's rendering.
* **cosmwasm-stargate** - the extension of <a href="https://github.com/cosmos/cosmjs" target="_blank" rel="noopener noreferrer" className="text-[#25D695] hover:opacity-80 text-base font-bold">CosmJS</a>, used for the interaction with
  the Coreum chain.
* <a href="https://daisyui.com/" target="_blank" rel="noopener noreferrer" className="text-[#25D695] hover:opacity-80 text-base font-bold">Daisyui</a> - UI styles and components.
* <a href="https://www.keplr.app/" target="_blank" rel="noopener noreferrer" className="text-[#25D695] hover:opacity-80 text-base font-bold">Keplr</a> - wallet used for the transactions signing.

## Source Code

The complete app source code is located <a href="https://github.com/CoreumFoundation/tutorials/tree/main/ts/web-app" target="_blank" rel="noopener noreferrer" className="text-[#25D695] hover:opacity-80 text-base font-bold">here</a>.
...
Parameters for other networks are available on the [network variables](/docs/v4/nodes-and-validators/essentials/network-variables) page.
...
The <a href="https://www.keplr.app/" target="_blank" rel="noopener noreferrer" className="text-[#25D695] hover:opacity-80 text-base font-bold">Keplr</a> wallet is used for the transaction signing. If you don't have it, install it for
...
Use the [API page](/docs/v4/api/protobuf)  to get the list of all supported transactions (the transactions are started from `Msg`
...
minted NFTs or the NFT owner, for example. Use the [API page](/docs/v4/api/protobuf) to get the list of all supported queries
(the queries are in the `Query` proto services and located in the `query.proto` files).

#### Extend Coreum transactions and queries.

The [Using CosmJS#](/docs/v4/tutorials/smart-contracts/using-cosmjs-with-wasm-contracts) explains how to generate the TypeScript code from the protos, here for the simplicity
...
* Read Coreum [modules](/docs/v4/modules/overview) specification, to be familiar with the custom Coreum functionality you can
  use for your
  application.
* Read <a href="https://docs.cosmos.network/v0.47/build/modules" target="_blank" rel="noopener noreferrer" className="text-[#25D695] hover:opacity-80 text-base font-bold">cosmos-sdk modules docs</a>.
* In some cases you might need the data that the node doesn't return, in that case, you can check the
  [Explorer API](/docs/v4/tools-and-ecosystem/blockchain-explorers) to understand what additionally you can get from the indexed data.
* Check other [tutorials](/docs/v4/tutorials/overview) to find something you might be interested in additionally.
