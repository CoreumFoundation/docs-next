    ...
    items: [
      {
        ...
        href: '/docs/v4/tutorials/get-started/cli/transfer-funds-with-cli',
        external: false,
      },
      {
  ...
  wasm: {
    ...
    items: [
      ...
      },
      {
        ...
        href: '/docs/v4/tutorials/smart-contracts/smart-ft-with-wasm',
        external: false,
      },
      {
        label: 'Testing multiple contracts',
        href: '/docs/v4/tutorials/smart-contracts/testing-multiple-contracts',
        external: false,
      },
      {
        label: 'Using CosmJS with WASM contracts',
        href: '/docs/v4/tutorials/smart-contracts/using-cosmjs-with-wasm-contracts',
        external: false,
      },
    ],
  },
  use_tokens: {
    ...
    items: [
      ...
      },
      {
        ...
        href: '/docs/v4/tutorials/smart-tokens/create-and-manage-nft',
        external: false,
      },
      {
        label: 'Smart FT with WASM',
        href: '/docs/v4/tutorials/smart-tokens/use-cases/airdrop-token',
        external: false,
      },
      {
    ...
    items: [
      {
        ...
        href: '/docs/v4/tutorials/build-apps/development-environment',
        external: false,
      },
      {
        label: 'Web app',
  ...
  iso: {
    ...
    items: [
      ...
      },
      {
        ...
        href: '/docs/v4/tutorials/ISO20022/ISO2022-client',
        external: false,
      },
    ],
  }
