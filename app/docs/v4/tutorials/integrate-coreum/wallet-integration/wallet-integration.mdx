...
* [CLI](/docs/v4/tutorials/get-started/cli/transfer-funds-cli)
* programmatically with [go](/docs/v4/tutorials/use-tokens/create-and-manage-ft-with-golang) or [TS](/docs/v4/tutorials/get-started/typescript/cosmjs)
