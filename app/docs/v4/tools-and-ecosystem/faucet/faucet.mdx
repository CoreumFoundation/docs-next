...
-   (for all users) Go to [wallet](/docs/v4/tools-and-ecosystem/wallets) page, connect(install) wallet and create account
    there;
...
[network variables page](/docs/v4/tutorials/get-started/setup-cli)
