...
following [this instruction](/docs/v4/nodes-and-validators/run-full-node).
...
1. At the `proposal` section at the [block explorer](/docs/v4/tools-and-ecosystem/blockchain-explorers)
...
export NEW_CORED_VERSION="v4.1.2"
export UPGRADE="v4patch2"
...
The printed version should match `v4.1.2`. If the version doesn't match stop following this tutorial immediately!
