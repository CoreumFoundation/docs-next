...
| **Cored version**      | v4.1.2                                                                                                       | v4.1.2                                                                                                                                                   | You can find the link to binary at [this page](/docs/v4/become-validator/essentials/install-cored) | already installed via crust |
| **Upgrade name**       | Check the `Name` column [here](/docs/v4/become-validator/upgrades/history)                                      | Check the `Name` column [here](/docs/v4/become-validator/upgrades/history)                                                                                  | genesis                                                  | genesis                     |
