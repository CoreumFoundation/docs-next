...
| **GRPC URL**               | Run your Mainnet Coreum node use https://full-node.mainnet-1.coreum.dev:9090                                 | Run your Testnet Coreum node use https://full-node.testnet-1.coreum.dev:9090                                         | localhost:9090              |
