...
| **GRPC URL**               | Run your Coreum node use <a href="https://full-node.mainnet-1.coreum.dev:9090" target="_blank" rel="noopener noreferrer" className="text-[#24D494] font-bold">GRPC URL Mainnet</a>                                         | Run your Coreum node use <a href="https://full-node.testnet-1.coreum.dev:9090" target="_blank" rel="noopener noreferrer" className="text-[#24D494] font-bold">GRPC URL Testnet</a>                                         | localhost:9090              |
