...
4.  For tokens originating from Coreum and Cosmos, the Bridge Contract directly dispatches the tokens to the recipient. In the case of XRPL-native tokens, the contract mints a <a href="https://www.coreum.com/smart-tokens" target="_blank" rel="noopener noreferrer" style={{ color: '#24D494', fontWeight: 'bold' }}>Smart Token</a> on Coreum which is a representation of the original XRPL asset, equipped with Minting, Burning, and IBC functionalities. The token is then sent to the recipient.
