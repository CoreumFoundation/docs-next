...
The Token Registry, is an open-source <a href="https://github.com/CoreumFoundation/token-registry" target="_blank" rel="noopener noreferrer" style={{ color: '#24D494' }}>repository</a> designed to facilitate the registration of tokens from the XRPL, Coreum, and the Cosmos ecosystem for use on the XRPL-Coreum Bridge.
