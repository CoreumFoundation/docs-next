...
The data aggregator scans blocks near real time as they are produced by the block chain.
...
The NETWORKS env is a json which can hold one or more Coreum nodes, 1 per network.
