...
* [Check requirements](hardware-requirements.md)
...
* (Optional) Enable REST APIs disabled by default.
  ...
  ```
  If you face `File contains parsing errors`  issue, check [troubleshooting section](troubleshooting.md#error-parsing-apptoml)
...
You can run [validator node](run-validator.md)
