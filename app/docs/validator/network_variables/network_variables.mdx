...
| **Cored version**      | v3.0.3                                                                                                       | v3.0.3                                                                                                                                                   | You can find the link to binary at [this page](cored.md) | already installed via crust |
| **Upgrade name**       | Check the `Name` column [here](./upgrade-history.md#mainnet)                                                 | Check the `Name` column [here](./upgrade-history.md#testnet)                                                                                             | genesis                                                  | genesis                     |
