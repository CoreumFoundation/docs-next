...
minted NFTs or the NFT owner for example, the [API page](/docs/api/protobuf) provides detailed information about Coreum's Protobuf API.
...
For example, the tutorial will show you how to generate TypeScript code from the protos, here for the simplicity
