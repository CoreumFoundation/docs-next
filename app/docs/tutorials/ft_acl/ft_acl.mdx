...
* Verify that [network variables](network-variables.md) are set up correctly.

* The first step is to create a multisig account. Follow the steps in [multisig creation](multisig.md) to set it up.
