...
* Follow the [instruction](cored.md) to install cored binary.
* Install the required util: `jq`.
* Set the [network variables](network-variables.md) for the development (testnet is preferable).
...
Use the [faucet](../tools-ecosystem/faucet.md) to fund your account
...
about [Coreum Fungible Token](../modules/assetft.md). Also, on the instantiation we declare the `owner` the address of
...
* Read Coreum [modules](../modules/main.md) specification, to be familiar with the custom Coreum functionality you can
  use for your application.
* Read [WASM docs](https://docs.cosmwasm.com/docs/) to understand all supported WASM features.
* Check other [tutorials](main.md) to find something you might be interested in additionally. 
