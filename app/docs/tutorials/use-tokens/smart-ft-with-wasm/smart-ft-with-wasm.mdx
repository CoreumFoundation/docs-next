...
* Install <a href="https://www.rust-lang.org/tools/install" target="_blank" rel="noopener noreferrer" className="text-[#24cc8e] hover:text-[#1db07a] text-lg font-bold">rust and cargo</a>.
...
The complete source code is located <a href="https://github.com/CoreumFoundation/tutorials/tree/main/wasm/ft-airdrop" target="_blank" rel="noopener noreferrer" className="text-[#24cc8e] hover:text-[#1db07a] text-lg font-bold">here</a>.
## Getting Started
...
about <a href="/docs/modules/coreum-fungible-token" target="_blank" rel="noopener noreferrer" className="text-[#24cc8e] hover:text-[#1db07a] text-md font-bold">Coreum Fungible Token</a>
...
* Read <a href="https://docs.cosmwasm.com/docs/" target="_blank" rel="noopener noreferrer" className="text-[#24cc8e] hover:text-[#1db07a] text-md font-bold">WASM docs</a> to understand all supported WASM features.
