...
This tutorial will guide you through the process of using the <a href="/docs/modules/coreum-non-fungible-token" target="_blank" rel="noopener noreferrer" class="text-[#24cc8e] hover:text-[#1db07a] text-md font-bold">assetnft</a>
...
-   <a href="/docs/tutorials/get-started/install-cored" target="_blank" rel="noopener noreferrer">cored binary installed</a>
...
-   We are going to interact with testnet, so we need to set `--node` and `--chain-id` flag in each
    ...
    <a href="/docs/tutorials/get-started/setup-cli" target="_blank" rel="noopener noreferrer" class="text-[#24cc8e] hover:text-[#1db07a] text-md font-bold">network variables</a>
 page.
...
-   Two accounts at your local keychain. If you don't have them, follow these steps - go to
 ...
 and generate two accounts there. Then, having the
...
-   Let's create new NFT class:
    ...
    <a href="/docs/tools/blockchain-explorers" target="_blank" rel="noopener noreferrer" class="text-[#24cc8e] hover:text-[#1db07a] text-md font-bold">Block explorer</a>
 to see the tx status. Features:
...
<a href="/docs/overview/smart-tokens" target="_blank" rel="noopener noreferrer" class="text-[#24cc8e] hover:text-[#1db07a] text-md font-bold">Smart Token Overview</a>
 and
<a href="/docs/modules/coreum-non-fungible-token" target="_blank" rel="noopener noreferrer" class="text-[#24cc8e] hover:text-[#1db07a] text-md font-bold">assetnft spec</a>
 pages
