...
This tutorial will guide you through the process of using the [assetnft](../../modules/assetnft.md)
...
-   [cored binary installed](../cored.md)
...
-   Two accounts at your local keychain. If you don't have them, follow these steps - go to
    [faucet page](../../tools-ecosystem/faucet.md) and generate two accounts there. Then, having the
...
-   Let's create new NFT class:
    ...
    [Block explorer](../../tools-ecosystem/block-explorer.md) to see the tx status. Features:
...
[Smart Token Overview](../../overview/smart-tokens.md) and
[assetnft spec](../../modules/assetnft.md) pages
