...
This tutorial will guide you through the process of using the <a href="/docs/modules/coreum-non-fungible-token" target="_blank" rel="noopener noreferrer">assetnft</a>
...
-   We will now mint 2 NFTs within created class
    ...
    [Block explorer](/docs/tools/blockchain-explorers) page
