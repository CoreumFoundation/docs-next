...
```bash
  ...
  Copy this hash and go to the [Block explorer](../../tools-ecosystem/block-explorer.md) to see the transaction's status.
...
-   First, we need a third account to transfer tokens to, let's
    [generate](../../tools-ecosystem/faucet.md) it and prepare:
    ```bash
