...
-   Since we have enabled the `minting` feature, the token admin can mint additional tokens by
    ...
    ```bash
    cored q bank total-supply-of=$FT_DENOM --node=$RPC_URL
    # amount: "200"
    # denom: cmyft-testcore1m4mm44zh9unlpg74nnqxmvwrkm5a20tmaes2z7
    ```
