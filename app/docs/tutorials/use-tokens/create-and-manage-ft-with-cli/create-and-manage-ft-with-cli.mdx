...
[network variables](/docs/become-validator/essentials/network-variables)
 page.

- [Install cored binary](/docs/tutorials/get-started/install-cored)

- You should have two accounts on your local keychain. If you do not have them, you can go to the [faucet page](/docs/tools/faucet) and generate funded accounts for the testnet.
...
The `burn-rate` works similarly to the [send-commission-rate](/docs/overview/smart-tokens). The
...
You can read more about Fungible Tokens at [Smart Token Spec](/docs/modules/coreum-fungible-token).
 pages
