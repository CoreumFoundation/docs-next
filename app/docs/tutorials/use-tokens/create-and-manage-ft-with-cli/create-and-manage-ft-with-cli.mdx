...
```bash
  # cored tx assetft issue [symbol] [subunit] [precision] [initial_amount] [description] --uri --uri-hash --from [admin] --features=burning,freezing,minting,whitelisting --burn-rate=0.12 --send-commission-rate=0.2 --extension-code-id=1 --extension-label=my-extension --extension-funds=100000ABC-testcore1adst6w4e79tddzhcgaru2l2gms8jjep6a4caa7 --extension-issuance-msg={} [flags]
  ...
  # uri-hash - example: e000624 (flag is optional)
