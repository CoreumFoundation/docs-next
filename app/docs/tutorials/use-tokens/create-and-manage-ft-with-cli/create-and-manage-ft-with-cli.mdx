...
This tutorial will guide you through the process of using the <a href="/docs/modules/coreum-fungible-token" rel="noopener noreferrer" class="text-[#24cc8e] hover:text-[#1db07a] text-md font-bold">assetft</a>
