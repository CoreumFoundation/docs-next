...
-   You should have two accounts on your local keychain. If you do not have them, you can go to the
    [faucet page](/docs/tools/faucet) and generate funded accounts for the testnet.
...
You can read more about Fungible Tokens at [Smart Token Spec](/docs/modules/coreum-fungible-token) pages
