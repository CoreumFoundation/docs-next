...
This tutorial will guide you through the process of using the [assetft](../../modules/assetft.md)
...
[network variables](../network-variables.md) page.
...
-   You should have two accounts on your local keychain. If you do not have them, you can go to the
    [faucet page](../../tools-ecosystem/faucet.md) and generate funded accounts for the testnet.
...
```bash
  ...
  ```
  ::: details "c" prefix in subunit name stays for `centi`, which means 10^(-2). Expand this section to see more details.
  {/* ![Figure 1 - Smart Tokens](./submultiples_prefixes.png) */}
  :::
...
The `burn-rate` works similarly to the [send-commission-rate](asset-ft.md#send-commission-rate). The
...
You can read more about Fungible Tokens at [Smart Token Spec](../../modules/assetft.md) pages
