...
This tutorial will guide you through the process of using the [assetft](/docs/modules/coreum-fungible-token)
...
-   First, we need a third account to transfer tokens to, let's [generate](/docs/tools/faucet) it and prepare:
    ```bash
