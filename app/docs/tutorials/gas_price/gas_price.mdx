...
The Coreum chain uses the [Coreum Fee Model](../modules/feemodel.md) for the `min gas price` calculation.
...
[RecommendedGasPrice](https://github.com/CoreumFoundation/coreum/blob/master/proto/coreum/feemodel/v1/query.proto)
...
the [MinGasPrice Query](https://github.com/CoreumFoundation/coreum/blob/master/proto/coreum/feemodel/v1/query.proto)
...
{/* ![](./assets/min_gas_price_chart.png) */}
...
The `initial gas price` is the gas price used in the [Coreum Fee Model](../modules/feemodel.md) as initial.
...
use: [Params Query](https://github.com/CoreumFoundation/coreum/blob/master/proto/coreum/feemodel/v1/query.proto)
and `ModelParams.initial_gas_price` in the result.
Or you can get it manually on the [explorer params page (Fee Model section)](https://explorer.coreum.com/coreum/params).
