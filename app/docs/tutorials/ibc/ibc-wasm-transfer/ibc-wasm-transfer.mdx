...
See full repo here:
<a className="text-[#24D494] font-bold" href="https://github.com/CoreumFoundation/ibc-contract-tutorial/tree/master/ibc-transfer" target="_blank">IBC Wasm Transfer Tutorial</a>
