...
-   Set the [network variables](../network-variables.md). We will use both the mainnet and the
    testnet.
-   Have a general understanding of [IBC](https://ibc.cosmos.network/main/ibc/overview.html) and the
    [Hermes Relayer](https://hermes.informal.systems/index.html).

## Source Code

The complete source code is located
[here](https://github.com/CoreumFoundation/ibc-contract-tutorial/tree/master/ibc-call).
...
define them in
[ibc.rs](https://github.com/CoreumFoundation/ibc-contract-tutorial/tree/master/ibc-call/src/ibc.rs):
...
need to
[configure Hermes](https://hermes.informal.systems/documentation/configuration/description.html).
