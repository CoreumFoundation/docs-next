...
-   Follow the <a href="/docs/tutorials/get-started/install-cored" class="text-[#24cc8e] hover:text-[#1db07a] text-md font-bold">instruction</a> to install cored binary.
-   Set the [network variables](/docs/tutorials/get-started/setup-cli). We will use both the mainnet and the
    testnet.
-   Have a general understanding of and the
    <a href="https://hermes.informal.systems/index.html" target="_blank" rel="noopener noreferrer" class="text-[#24cc8e] hover:text-[#1db07a] text-md font-bold">Hermes Relayer</a>
