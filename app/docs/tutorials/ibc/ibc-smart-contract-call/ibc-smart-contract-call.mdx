...
-   Follow the <a href="/docs/tutorials/get-started/install-cored" class="text-[#24cc8e] hover:text-[#1db07a] text-lg font-bold">instruction</a> to install cored binary.
-   Set the <a href="/docs/tutorials/get-started/setup-cli" target="_blank" rel="noopener noreferrer" class="text-[#24cc8e] hover:text-[#1db07a] text-md font-bold">network variables</a>. We will use both the mainnet and the
    testnet.
-   Have a general understanding of and the
    <a href="https://hermes.informal.systems/index.html" target="_blank" rel="noopener noreferrer" class="text-[#24cc8e] hover:text-[#1db07a] text-lg font-bold">Hermes Relayer</a>


## Source Code

The complete source code is located
<a href="https://github.com/CoreumFoundation/ibc-contract-tutorial/tree/master/ibc-call" target="_blank" rel="noopener noreferrer" class="text-[#24cc8e] hover:text-[#1db07a] text-md font-bold">here</a>
...
define them in
<a href="https://github.com/CoreumFoundation/ibc-contract-tutorial/tree/master/ibc-call/src/ibc.rs" target="_blank" rel="noopener noreferrer" class="text-[#24cc8e] hover:text-[#1db07a] text-md font-bold">ibc.rs</a>:
...
To establish a connection between the two contracts you need to set up a relayer. First, we will
need to
<a href="https://hermes.informal.systems/documentation/configuration/description.html" target="_blank" rel="noopener noreferrer" class="text-[#24cc8e] hover:text-[#1db07a] text-md font-bold">configure Hermes</a>
