...
- `docker` (if you are installing from pacakge manager make sure that `docker-buildx` is installed.
    ...
    , from this <a href="https://docs.docker.com/engine/install/" target="_blank" rel="noopener noreferrer" className="text-[#24cc8e] hover:text-[#1db07a] text-lg font-bold">link</a>
)
