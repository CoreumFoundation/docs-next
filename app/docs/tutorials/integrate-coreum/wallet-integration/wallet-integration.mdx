...
To understand Coreum chain gas price read about the [coreum gas price](/docs/modules/coreum-deterministic-gas).
...
You can find more information about our `deterministicgas` model [here](/docs/modules/coreum-deterministic-gas).
...
More information about FT module is covered <a href="/docs/modules/coreum-fungible-token" target="_blank" rel="noopener noreferrer">here</a>.
Moreover, there are several guides describing different ways of interacting with fungible token:
* [CLI](/docs/tutorials/get-started/cli/transfer-funds-cli) 
* programmatically with <a href="/docs/tutorials/get-started/golang" target="_blank" rel="noopener noreferrer">go</a> or <a href="/docs/tutorials/get-started/typescript/cosmjs" target="_blank" rel="noopener noreferrer">TS</a>
