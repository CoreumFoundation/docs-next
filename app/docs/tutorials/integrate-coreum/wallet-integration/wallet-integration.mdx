...
To understand Coreum chain gas price read about the <a href="/docs/modules/coreum-deterministic-gas" target="_blank" rel="noopener noreferrer" class="text-[#24cc8e] hover:text-[#1db07a] text-md font-bold">coreum gas price</a>.
...
You can find more information about our `deterministicgas` model <a href="/docs/modules/coreum-deterministic-gas" target="_blank" rel="noopener noreferrer" class="text-[#24cc8e] hover:text-[#1db07a] text-md font-bold">here</a>.
...
More information about FT module is covered <a href="/docs/modules/coreum-fungible-token" target="_blank" rel="noopener noreferrer" class="text-[#24cc8e] hover:text-[#1db07a] text-md font-bold">here</a>.
Moreover, there are several guides describing different ways of interacting with fungible token:
* <a href="/docs/tutorials/get-started/cli/transfer-funds-cli" class="text-[#24cc8e] hover:text-[#1db07a] text-md font-bold">CLI</a>
* programmatically with <a href="/docs/tutorials/get-started/golang" target="_blank" rel="noopener noreferrer" class="text-[#24cc8e] hover:text-[#1db07a] text-md font-bold">go</a> or <a href="/docs/tutorials/get-started/typescript/cosmjs" target="_blank" rel="noopener noreferrer" class="text-[#24cc8e] hover:text-[#1db07a] text-md font-bold">TS</a>
