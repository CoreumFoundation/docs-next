...
More information about FT module is covered [here](/docs/modules/coreum-fungible-token).
...
* programmatically with <a href="https://test.docs.coreum.dev/docs/tutorials/use-tokens/create-and-manage-nft-with-golang" target="_blank" rel="noopener noreferrer" className="text-[#24D494] font-bold">go</a>
 or [TS](/docs/tutorials/get-started/typescript/cosmjs)
