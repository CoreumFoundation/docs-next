...
To understand Coreum chain gas price read about the [coreum gas price](gas-price.md).
...
You can find more information about our `deterministicgas` model [here](./../modules/deterministicgas.md).
...
More information about FT module is covered [here](../modules/assetft.md).
Moreover, there are several guides describing different ways of interacting with fungible token:
* [CLI](./smart-tokens/asset-ft.md) 
* programmatically with [go](./smart-tokens/asset-ft-go.md) or [TS](./cosmjs.md)
