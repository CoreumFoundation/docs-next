...
First we answer common questions coming from exchanges. Then we present [code examples](#code-examples) written in Golang and TypeScript on how to communicate with our chain.
...
### Links
- <a href="https://www.coreum.com" target="_blank" rel="noopener noreferrer" className="text-[#25D695] hover:opacity-80 text-base font-bold">Official website</a>
- <a href="https://github.com/CoreumFoundation/coreum" target="_blank" rel="noopener noreferrer" className="text-[#25D695] hover:opacity-80 text-lg font-bold">Source code</a>
- [Block explorers](/docs/tools/blockchain-explorers)
- <a href="https://docs.coreum.dev" target="_blank" rel="noopener noreferrer" className="text-[#25D695] hover:opacity-80 text-base font-bold">Documentation</a>
...
To understand Coreum chain fees read about the [coreum gas price](/docs/tutorials/gas-price).
...
To get funded account, go to our faucet website: [Faucet](/docs/tools/faucet) and click on "Generate Funded Wallet" button in "Testnet" section.
...
Now we are ready to broadcast transaction. As an example we send `9000000utestcore` tokens from `sender` wallet to `recipient`. After executing the transaction you may copy transaction hash and paste it in the search box of our block <a href="https://explorer.testnet-1.coreum.dev/coreum" target="_blank" rel="noopener noreferrer" className="text-[#25D695] hover:opacity-80 text-base font-bold">explorer</a> to confirm the transaction execution and check its properties.
