...
To get funded account, go to our faucet website: <a href="https://docs.coreum.dev/tools-ecosystem/faucet" target="_blank" rel="noopener noreferrer">https://docs.coreum.dev/tools-ecosystem/faucet</a>
