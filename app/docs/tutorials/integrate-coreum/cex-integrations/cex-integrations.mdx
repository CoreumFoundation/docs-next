...
- <a href="/docs/tools/blockchain-explorers" class="text-[#24cc8e] hover:text-[#1db07a] text-md font-bold">Block explorers</a>
- <a href="https://docs.coreum.dev" target="_blank" rel="noopener noreferrer">Documentation</a>
- <a href="/docs/tools/faucet" class="text-[#24cc8e] hover:text-[#1db07a] text-md font-bold">Faucet</a>
...
To understand Coreum chain fees read about the <a href="/docs/modules/coreum-deterministic-gas" class="text-[#24cc8e] hover:text-[#1db07a] text-md font-bold">coreum gas price</a>.
...
// TODO: USe gas estimation once <a href="https://github.com/CoreumFoundation/coreum/pull/403" target="_blank" rel="noopener noreferrer">https://github.com/CoreumFoundation/coreum/pull/403</a>
