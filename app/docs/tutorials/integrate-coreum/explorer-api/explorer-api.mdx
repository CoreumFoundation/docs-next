...
The list of supported `Explorer APIs` can be found on the page <a href="/docs/tutorials/get-started/setup-cli" class="text-[#24cc8e] hover:text-[#1db07a] text-md font-bold" target="_blank" rel="noopener noreferrer">network-variables.md</a>
