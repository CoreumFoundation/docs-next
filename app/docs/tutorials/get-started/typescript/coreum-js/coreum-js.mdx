...
3. Put the code from the <a href="/docs/tutorials/get-started/typescript/coreum-js" target="_blank" rel="noopener noreferrer" class="text-[#24cc8e] hover:text-[#1db07a] text-md font-bold">following section</a> into `index.js` file. Refer to the comments for explanation.
4. Generate a mnemonic for the testnet network <a href="/docs/tools/faucet" target="_blank" rel="noopener noreferrer" class="text-[#24cc8e] hover:text-[#1db07a] text-md font-bold">here</a>.
...
// Replace the issuerMnemonic with your own. You can generate it at <a href="https://docs.coreum.dev/tools-ecosystem/faucet.html" target="_blank" rel="noopener noreferrer">https://docs.coreum.dev/tools-ecosystem/faucet.html</a>
...
// Replace the issuerMnemonic with your own. You can generate it at <a href="https://docs.coreum.dev/tools-ecosystem/faucet.html" target="_blank" rel="noopener noreferrer" class="text-[#24cc8e] hover:text-[#1db07a] text-md font-bold">https://docs.coreum.dev/tools-ecosystem/faucet.html</a>
