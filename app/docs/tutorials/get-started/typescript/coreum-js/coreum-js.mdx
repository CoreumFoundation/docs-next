...
3. Put the code from the [following section](/docs/tutorials/get-started/typescript/coreum-js) into `index.js` file. Refer to the comments for explanation.
4. Generate a mnemonic for the testnet network [here](/docs/tools/faucet).
...
// Replace the issuerMnemonic with your own. You can generate it at [https://docs.coreum.dev/tools-ecosystem/faucet.html](https://docs.coreum.dev/tools-ecosystem/faucet.html)
