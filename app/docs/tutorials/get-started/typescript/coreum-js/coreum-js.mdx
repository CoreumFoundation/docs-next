...
3. Put the code from the [following section](/docs/tutorials/get-started/typescript/coreum-js) into `index.js` file. Reffer to the comments for the explanation.
4. Generate mnemonic for the testnet network [here](/docs/tools/faucet).
...
// Replace the issuerMnemonic with your own. You can generate it at https://docs.coreum.dev/docs/tools/faucet
