...
3. Put the code from the [following section](coreum-js.md#full-code) into `index.js` file. Reffer to the comments for the explanation.
4. Generate mnemonic for the testnet network [here](../tools-ecosystem/faucet.md#testnet).
