...
*Follow the instructions provided by Microsoft to install Windows Subsystem for Linux (WSL):* <a href="https://learn.microsoft.com/en-us/windows/wsl/install" target="_blank" rel="noopener noreferrer" class="text-[#24cc8e] hover:text-[#1db07a] text-md font-bold">Install WSL</a>
