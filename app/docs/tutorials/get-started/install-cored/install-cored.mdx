...
* Verify that <a href="/docs/tutorials/get-started/setup-cli"  target="_blank" rel="noopener noreferrer" className="text-[#24cc8e] hover:text-[#1db07a] text-md font-bold">network variables</a>
...
* * If you are getting 404 error at this step, run:
    ...
    ```
    And check if it generates a right link. It should lead to one of our <a href="https://github.com/CoreumFoundation/coreum/releases" target="_blank" rel="noopener noreferrer" class="text-[#24cc8e] hover:text-[#1db07a] text-md font-bold">releases</a>
...
The <a href="https://github.com/CoreumFoundation/coreum/blob/master/README.md#build-and-play" target="_blank" rel="noopener noreferrer" class="text-[#24cc8e] hover:text-[#1db07a] text-md font-bold">Build and Play</a>
 doc describes the
