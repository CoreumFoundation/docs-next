...
The complete source code is located <a href="https://github.com/CoreumFoundation/tutorials/tree/main/wasm/ft-airdrop" target="_blank" rel="noopener noreferrer" className="text-[#25D695] hover:opacity-80 text-base font-bold">here</a>.
