...
The complete source code is located <a href="https://github.com/CoreumFoundation/tutorials/tree/main/wasm/ft-airdrop" target="_blank" rel="noopener noreferrer" class="text-[#24cc8e] hover:text-[#1db07a] text-lg font-bold">here</a>.
...
about [Coreum Fungible Token](/docs/modules/coreum-fungible-token)
