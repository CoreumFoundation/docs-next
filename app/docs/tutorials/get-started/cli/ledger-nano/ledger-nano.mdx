...
* `cored` ([Coreum CLI](/docs/become-validator/essentials/install-cored)
...
- If you want to target other network than testnet, replace it with values at [network variables page](/docs/become-validator/essentials/network-variables)
...
* Fund your account address
  ...
  * Navigate <a href="/docs/tools/faucet"  rel="noopener noreferrer" class="text-[#24cc8e] hover:text-[#1db07a] text-md font-bold">faucet</a>
...
* Click the `Connect to coreum-testnet-1` button to establish a connection with the Coreum testnet chain.
  ...
  listed on <a href="/docs/tools/wallets"  class="text-[#24cc8e] hover:text-[#1db07a] text-md font-bold">Coreum Docs page</a>.
...
* To fund the test account:
  ...
  * Open the [faucet page](/docs/tools/faucet)
