...
* Set up <a href="https://www.ledger.com/ledger-live/" target="_blank" rel="noopener noreferrer" class="text-[#24cc8e] hover:text-[#1db07a] text-md font-bold">Ledger Live</a>
 on your machine.

* The Cosmos(ATOM) application must be installed on your Ledger device, for more information click <a href="https://support.ledger.com/hc/en-us/articles/360013713840-Cosmos-ATOM-?support=true" target="_blank" rel="noopener noreferrer" class="text-[#24cc8e] hover:text-[#1db07a] text-md font-bold">here</a>
. (Make sure that Cosmos(ATOM) app version is v2.34.12 or above)

* `cored` (<a href="/docs/tutorials/get-started/install-cored" target="_blank" rel="noopener noreferrer" class="text-[#24cc8e] hover:text-[#1db07a] text-lg font-bold">Coreum CLI</a>
) installed on your local machine (install cored binary version v1.0.0 or above)
...
- If you want to target other network than testnet, replace it with values at <a href="/docs/tutorials/get-started/setup-cli" target="_blank" rel="noopener noreferrer" class="text-[#24cc8e] hover:text-[#1db07a] text-lg font-bold">network variables page</a>
...
* Fund your account address
  ...
  * Navigate <a href="/docs/tools/faucet" target="_blank" rel="noopener noreferrer" class="text-[#24cc8e] hover:text-[#1db07a] text-md font-bold">faucet</a>
...
* Install the <a href="https://www.keplr.app/" target="_blank" rel="noopener noreferrer" class="text-[#24cc8e] hover:text-[#1db07a] text-md font-bold">Keplr browser extension</a>
...
* Connect to the [Coreum Chain](/docs/tools/wallets) to add the Coreum account.
  :::details OPTIONAL
  Way to add `Coreum Mainnet` chain to the `Keplr` extension:
  * Navigate to <a href="https://chains.keplr.app/" target="_blank" rel="noopener noreferrer" class="text-[#24cc8e] hover:text-[#1db07a] text-lg font-bold">Add Chains to Keplr</a>.
...
* Click the `Connect to coreum-testnet-1` button to establish a connection with the Coreum testnet chain.
  ...
  listed on <a href="/docs/tools/wallets" target="_blank" rel="noopener noreferrer" class="text-[#24cc8e] hover:text-[#1db07a] text-md font-bold">Coreum Docs page</a>.
...
* To fund the test account:
  ...
  * Open the <a href="/docs/tools/faucet" target="_blank" rel="noopener noreferrer" class="text-[#24cc8e] hover:text-[#1db07a] text-md font-bold">faucet</a>
 and paste the copied address into the designated address field.
...
Great! You have successfully set up Keplr with your Ledger Nano. For more comprehensive details, you can refer to the <a href="https://support.ledger.com/hc/en-us/articles/4411149814417?docs=true" target="_blank" rel="noopener noreferrer" class="text-[#24cc8e] hover:text-[#1db07a] text-lg font-bold">Ledger support page</a>/
