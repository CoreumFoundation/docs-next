...
If you want to target other network than testnet, replace it with values at <a href="/docs/tutorials/get-started/setup-cli" rel="noopener noreferrer" class="text-[#24cc8e] hover:text-[#1db07a] text-md font-bold">network variables page</a>
...
* Transfer funds. Let's go step by step, `--help` command will lead us through:
  ...
  * `bank` module is responsible for transferring funds:
    ...
    -   If the output code is 0, get the transaction hash, go to
        <a href="/docs/tools/blockchain-explorers" rel="noopener noreferrer" class="text-[#24cc8e] hover:text-[#1db07a] text-md font-bold">Block Explorer</a>
...
-   Let's delegate some tokens:
  ...
  * If the output code is 0, get the transaction hash, go to <a href="/docs/tools/blockchain-explorers" rel="noopener noreferrer" class="text-[#24cc8e] hover:text-[#1db07a] text-md font-bold">Block Explorer</a>
 and put it into the search line.
