...
-   <a href="/docs/become-validator/essentials/install-cored" target="_blank" rel="noopener noreferrer" class="text-[#24cc8e] hover:text-[#1db07a] text-md font-bold">Install cored binary</a>
...
If you want to target other network than testnet, replace it with values at<a href="/docs/tutorials/get-started/setup-cli" target="_blank" rel="noopener noreferrer" class="text-[#24cc8e] hover:text-[#1db07a] text-md font-bold">network variables page</a>
...
* You should have funded account. If you don't have it, do next:
  * Go to <a href="/docs/tools/faucet" target="_blank" rel="noopener noreferrer" class="text-[#24cc8e] hover:text-[#1db07a] text-md font-bold">faucet page</a>
...
* Transfer funds. Let's go step by step, `--help` command will lead us through:
 ...
 and put it into the search line.
...
-   Let's delegate some tokens:
  ...
  * If the output code is 0, get the transaction hash, go to <a href="/docs/tools/blockchain-explorers" target="_blank" rel="noopener noreferrer" class="text-[#24cc8e] hover:text-[#1db07a] text-md font-bold">Block Explorer</a>
 and put it into the search line.
