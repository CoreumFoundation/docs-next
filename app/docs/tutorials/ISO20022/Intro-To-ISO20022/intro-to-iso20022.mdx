...
<center className="w-full max-w-full mt-2 mb-6 mx-auto">
    <img src="/images/tutorials/iso20022/Intro.png" alt="Open Keplr Wallet" />
</center>
...
### 3. **API Usage**
The institution uses an API (Application Programming Interface) to interact with systems such as SWIFT, Tradeheader, or internal software, facilitating the message transmission.

### 4. **Encryption with Public Key B**
...
### 8. **Tags, Elements, and Attributes**
Within the XML:
...
### 12. **Decryption by Institution A**
