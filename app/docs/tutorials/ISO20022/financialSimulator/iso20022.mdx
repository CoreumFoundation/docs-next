...
<center className="w-full max-w-full mt-2 mb-6 mx-auto">
    <img src="./public/images/tutorials/iso20022/financialSimulator.png" alt="Open Keplr Wallet" />
</center>
...
<center className="w-md max-w-md mt-2 mb-6 mx-auto">
    <img src="./public/images/tutorials/iso20022/HowItWorks.png" alt="Open Keplr Wallet" />
</center>
...
#### Generate Keys: 
Generate the necessary cryptographic keys, which are essential for securing transactions and ensuring correct processing within the blockchain. These keys are used to encrypt/decrypt the ISO messages that will be transferred.
...
<center className="w-full max-w-full mt-2 mb-6 mx-auto">
    <img src="./public/images/tutorials/iso20022/Confirmation.png" alt="Open Keplr Wallet" />
</center>
...
<center className="w-full max-w-full mt-2 mb-6 mx-auto">
    <img src="./public/images/tutorials/iso20022/isoConfirm.png" alt="Open Keplr Wallet" />
</center>
...
<center className="w-full max-w-full mt-2 mb-6 mx-auto">
    <img src="./public/images/tutorials/iso20022/reject.png" alt="Open Keplr Wallet" />
</center>
