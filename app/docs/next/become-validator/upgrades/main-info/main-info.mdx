...
following [this instruction](/docs/next/become-validator/run-full-node).
...
1. At the `proposal` section at the [block explorer](/docs/next/tools/blockchain-explorers)
