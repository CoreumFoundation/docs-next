...
* Fund the account.
  ...
  * For the Testnet and Devnet you can request test tokens in the <a className="text-[#24D494] font-bold" href="https://docs.coreum.dev/docs/tools/faucet" target="_blank">faucet</a>
