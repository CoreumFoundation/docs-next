...
matching. The events are defined in the <a href="https://github.com/CoreumFoundation/coreum/blob/master/proto/coreum/dex/v1/event.proto" target="_blank" rel="noopener noreferrer" className="text-[#25D695] hover:opacity-80 text-base font-bold">event.proto</a>. The events are emitted
