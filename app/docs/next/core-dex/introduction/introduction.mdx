...
See the <a href="/docs/next/nodes-and-validators/run-full-node" target="_blank" className="text-[#25D695] hover:opacity-80 text-base font-bold">Coreum</a>q for more information on how to install a local node.
