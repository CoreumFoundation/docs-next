...
Parameters for other networks are available on the [network variables](/docs/next/become-validator/essentials/network-variables) page.
...
* In some cases you might need the data that the node doesn't return, in that case, you can check the
  [Explorer API](/docs/next/tools/blockchain-explorers) to understand what additionally you can get from the indexed data.
