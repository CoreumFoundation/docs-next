...
The [Using CosmJS#](/docs/next/tutorials/smart-contracts/using-cosmjs-with-wasm-contracts) explains how to generate the TypeScript code from the protos, here for the simplicity
