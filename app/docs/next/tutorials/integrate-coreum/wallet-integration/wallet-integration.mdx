...
To understand Coreum chain gas price read about the [coreum gas price](/docs/next/modules/coreum-deterministic-gas).
...
You can find more information about our `deterministicgas` model [here](/docs/next/modules/coreum-deterministic-gas).
...
More information about FT module is covered [here](/docs/next/modules/coreum-fungible-token).
Moreover, there are several guides describing different ways of interacting with fungible token:
* [CLI](/docs/next/tutorials/get-started/cli/transfer-funds-cli)
* programmatically with [go](/docs/next/tutorials/use-tokens/create-and-manage-ft-with-golang) or [TS](/docs/next/tutorials/get-started/typescript/cosmjs)
