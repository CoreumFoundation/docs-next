...
* [CLI](/docs/next/tutorials/get-started/cli/transfer-funds-with-cli)
* programmatically with [go](/docs/next/tutorials/smart-tokens/create-and-manage-ft) or [TS](/docs/next/tutorials/get-started/typescript/cosmjs)
