...
-   Two accounts at your local keychain. If you don't have them, follow these steps - go to
    [faucet page](/docs/next/tools-and-ecosystem/faucet) and generate two accounts there. Then, having the
...
-   Let's create new NFT class:
    ...
    [Block explorer](/docs/next/tools-and-ecosystem/blockchain-explorers) to see the tx status. Features:
...
-   We will now mint 2 NFTs within created class
    ...
    [Block explorer](/docs/next/tools-and-ecosystem/blockchain-explorers) page
...
[the documentation](/docs/next/modules/cosmos-non-fungible-token)
