...
We can issue a new token like explain in [Create and Manage FT with CLI](/docs/next/tutorials/use-tokens/create-and-manage-ft-with-cli) but pass additional params for the extension.
...
* Read Coreum [modules](/docs/next/overview/modules) specification, to be familiar with the custom Coreum functionality you can
...
* Check other [tutorials](/docs/next/overview/tutorials) to find something you might be interested in additionally.
