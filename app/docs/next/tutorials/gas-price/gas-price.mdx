...
The Coreum chain uses the [Coreum Fee Model](/docs/next/modules/coreum-fee-model) for the `min gas price` calculation.
...
The `initial gas price` is the gas price used in the [Coreum Fee Model](/docs/next/modules/coreum-fee-model) as initial.
