...
<div style={{ textAlign: 'center' }}>
    <img src="/images/diagram.png" style={{ height: '500px', width: '500px' }} alt="ISO20022 Network Diagram"/>
</div>
...
<div style={{ textAlign: 'center' }}>
    <img src="/images/example.png" style={{ width: '500px' }} alt="PACS.008 Message Example"/>
</div>
...
To have that, you need to use a [wallet](/docs/next/tools-and-ecosystem/wallets)
