...
* `cored` ([Coreum CLI](/docs/tutorials/get-started/install-cored)) installed on your local machine (install cored binary version v1.0.0 or above)
...
* Fund your account address
  ...
  * Navigate [faucet page](/docs/tools/faucet) designed specifically for this purpose.
...
>
> listed on [Coreum Docs page](/docs/tools/wallets).
...
* To fund the test account:
  ...
  * Open the [faucet](/docs/tools/faucet) and paste the copied address into the designated address field.
