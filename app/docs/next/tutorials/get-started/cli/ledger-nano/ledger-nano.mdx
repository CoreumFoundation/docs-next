...
* Fund your account address
  ...
  * Navigate [faucet page](/docs/next/tools/faucet) designed specifically for this purpose.
...
* Connect to the [Coreum Chain](/docs/next/tools/wallets) to add the Coreum account.
  >[!NOTE]
  > OPTIONAL
...
>
> listed on [Coreum Docs page](/docs/next/tools/wallets).
...
* To fund the test account:
  ...
  * Open the [faucet](/docs/next/tools/faucet) and paste the copied address into the designated address field.
