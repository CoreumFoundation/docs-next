...
* The first step is to create a multisig account. Follow the steps in [multisig creation](/docs/next/tutorials/get-started/cli/send-multisig-transaction) to set it up.
...
* Use [faucet](/docs/next/tools-and-ecosystem/faucet) to fund `minter` account
