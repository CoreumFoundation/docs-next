...
4. Generate mnemonic for the testnet network [here](/docs/next/tools-and-ecosystem/faucet).
...
// Replace the issuerMnemonic with your own. You can generate it at https://docs.coreum.dev/docs/next/tools-and-ecosystem/faucet
