...
If you are looking for Validator Network Variables, go to [this page](/docs/next/nodes-and-validators/essentials/network-variables)
...
| **Cored version**     | v4.1.2                                         | v5.0.0                                         | check the latest devnet release               | already installed via crust      |
