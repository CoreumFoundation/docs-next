...
<a className="text-[#25D695] hover:opacity-80 font-bold" target="_blank" href="https://coreum.com">Coreum</a> is a 3rd-generation layer-1 enterprise-grade blockchain built to serve
as a core infrastructure for decentralized applications with ISO20022 compatibility, IBC
interoperability, and novel <a className="text-[#25D695] hover:opacity-80 font-bold" target="_blank" href="https://www.coreum.com/smart-tokens">Smart Tokens</a>.
...
[Smart Contracts page](/docs/next/overview/smart-contracts)
...
More details you can find at [Smart Tokens page](/docs/next/overview/smart-tokens)
...
-   Gas is deterministic for most of the transaction types. For example, if you want to transfer
    tokens, you know how much gas you need, without interacting with the chain in any way.
...
More details you can find at [Fee Model page](/docs/next/modules/coreum-fee-model)
