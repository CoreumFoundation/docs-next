...
| **Cored version**      | v4.1.2                                                                                                       | v4.1.2                                                                                                                                                   | You can find the link to binary at [this page](/docs/next/nodes-and-validators/essentials/install-cored) | already installed via crust |
| **Upgrade name**       | Check the `Name` column [here](/docs/next/nodes-and-validators/upgrades/upgrades-history)                                      | Check the `Name` column [here](/docs/next/nodes-and-validators/upgrades/upgrades-history)                                                                                  | genesis                                                  | genesis                     |
| **State sync servers** | https://full-node-californium.mainnet-1.coreum.dev:26657 https://full-node-curium.mainnet-1.coreum.dev:26657 | https://full-node-eris.testnet-1.coreum.dev:26657 https://full-node-pluto.testnet-1.coreum.dev:26657 | not supported                                            | not supported               |
