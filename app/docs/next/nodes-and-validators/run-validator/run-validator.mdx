...
* Follow instructions in [full node instruction](/docs/next/nodes-and-validators/run-full-node) first, but set the following config before
...
* Fund the account.
  * You can find the recommended amount with calculation at [this page](/docs/next/nodes-and-validators/essentials/how-much-fund-to-create-validator).
  * For the Testnet and Devnet you can request test tokens in the <a className="text-[#24D494] font-bold" href="/docs/next/tools-and-ecosystem/faucet" target="_blank">faucet</a>
...
* If you have done everything right, you can see your validator at [Block Explorer](/docs/next/tools-and-ecosystem/blockchain-explorers) validators section
...
- If your validator was jailed, you can find instructions how to unjail my validator [here](/docs/next/nodes-and-validators/validator/unjail-validator)
- If you don't want to expose your validator node to the internet, but still want to interact with the network,
  rou can [run sentry node](/docs/next/nodes-and-validators/validator/run-sentry).
