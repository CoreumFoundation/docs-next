...
- If your validator was jailed, you can find instructions how to unjail my validator [here](/docs/next/help/how-to-unjail-my-validator)
- If you don't want to expose your validator node to the internet, but still want to interact with the network,
  rou can [run sentry node](/docs/next/nodes-and-validators/run-sentry-node).
