...
* Enable state-sync, so your validator can sync by snapshot.
  ...
  instead of state-sync you should visit <a href="/docs/next/nodes-and-validators/upgrades/history" className="text-[#24D494] font-bold">this section</a>
...
You can run [validator node](/docs/next/nodes-and-validators/validator/run-validator)
