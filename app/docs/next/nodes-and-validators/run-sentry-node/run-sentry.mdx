...
* <a href="/docs/next/become-validator/essentials/system-requirements" className="text-[#25D695] hover:opacity-80 text-base font-bold">Check requirements</a>.

* <a href="/docs/next/become-validator/essentials/install-cored" className="text-[#25D695] hover:opacity-80 text-base font-bold">Install cored binary</a>.

* Verify that <a href="/docs/next/become-validator/essentials/network-variables" className="text-[#25D695] hover:opacity-80 text-base font-bold">network variables</a> are set up correctly.

* <a href="/docs/next/become-validator/essentials/node-prerequisites" className="text-[#25D695] hover:opacity-80 text-base font-bold">Set up node prerequisites</a>
...
* Capture the validator peer and ip that this node will connect to.
  ...
  **Attention!** *This command must be executed on the validator node.
  The "$COREUM_EXTERNAL_IP" is configured in the [doc](/docs/next/become-validator/essentials/connection-config)",
