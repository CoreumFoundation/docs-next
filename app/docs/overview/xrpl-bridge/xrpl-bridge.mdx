...
<a className="text-[#24D494] font-bold" href="https://github.com/CoreumFoundation/coreumbridge-xrpl" target="_blank">GitHub.</a>.
...
Audit of the bridge has been performed by <a className="text-[#24D494] font-bold" href="https://skynet.certik.com/projects/coreum" target="_blank">Certik</a>. The
final report will be published shortly.

## Architecture

For additional information, refer to the technical
<a className="text-[#24D494] font-bold" href="https://github.com/CoreumFoundation/coreumbridge-xrpl/blob/master/spec/spec.md" target="_blank">specifications</a>
...
<a className="text-[#24D494] font-bold" href="https://github.com/CoreumFoundation/token-registry" target="_blank">Github</a>
