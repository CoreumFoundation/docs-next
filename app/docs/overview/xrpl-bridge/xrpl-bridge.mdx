...
Each component's source code of the Bridge is open source and available on <a href="https://github.com/CoreumFoundation/coreumbridge-xrpl" target="_blank" rel="noopener noreferrer" className="text-[#24D494] font-bold">GitHub</a>.
...
Audit of the bridge has been performed by <a href="https://skynet.certik.com/projects/coreum" target="_blank" rel="noopener noreferrer" className="text-[#24D494] font-bold">Certik</a>. The final report will be published shortly.
...
<a href="https://github.com/CoreumFoundation/coreumbridge-xrpl/blob/master/spec/spec.md" target="_blank" rel="noopener noreferrer" className="text-[#24D494] font-bold">specifications</a>
...
The Token Registry is open source and available on <a href="https://github.com/CoreumFoundation/token-registry" target="_blank" rel="noopener noreferrer" className="text-[#24D494] font-bold">Github</a>.
