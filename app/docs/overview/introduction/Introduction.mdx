...
<a className="text-green-gradient font-bold" href="https://coreum.com" target="_blank">Coreum</a> is a 3rd-generation layer-1 enterprise-grade blockchain built to serve
as a core infrastructure for decentralized applications with ISO20022 compatibility, IBC
interoperability, and novel <a className="text-green-gradient font-bold" href="https://www.coreum.com/smart-tokens" target="_blank">Smart Tokens</a>.
...
**$CORE** is the native token for Coreum, and is used for interacting with the blockchain's various
...
<a className="text-green-gradient font-bold" href="https://sologenic.com" target="_blank">Sologenic Ecosystem</a>, which currently resides on the XRP Ledger.
...
<a className="text-green-gradient font-bold" href="/docs/overview/smart-contracts" target="_blank">Smart Contracts page</a>

### Smart tokens

Except native token **$CORE**, Coreum Network also provides ability to create custom tokens with
next features:
...
More details you can find at <a className="text-green-gradient font-bold" href="/docs/overview/smart-contracts" target="_blank">Smart Contracts page</a>
...
More details you can find at <a className="text-green-gradient font-bold" href="/docs/modules/coreum-fee-model" target="_blank">Fee Model page</a>


### Decentralised Exchange (DEX)

The DEX supports the trading of $CORE, as well as any issued assets found on Coreum.
