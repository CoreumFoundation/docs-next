...
<a className="text-green-gradient font-bold" href="https://cosmwasm.com/" target="_blank">CosmWasm</a>
...
referred to as the <a className="text-green-gradient font-bold" href="https://dspace.mit.edu/handle/1721.1/6952" target="_blank">actor model</a>
